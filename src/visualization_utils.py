...
def plot_icp_iterations_results(iterations_results, save_path):
    ...
    ax[0, 0].axvline(x=min_error_index, color='red', linestyle='--', label='Minimum Error')
    ...
    ax[0, 1].axvline(x=min_error_index, color='red', linestyle='--', label='Minimum Error')
    ...
    ax[1, 0].axvline(x=min_error_index, color='red', linestyle='--', label='Minimum Error')
    ...
    ax[1, 1].axvline(x=min_error_index, color='red', linestyle='--', label='Minimum Error')
